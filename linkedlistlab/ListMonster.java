...
public class ListMonster
{
  public static void main(String[] args)
  {
    ...
    test("toList", "2 elements", toString(Lab.toList(new String[]{"ab"})).equals("ab"));
    test("toList", "3 elements", toString(Lab.toList(new String[]{"abc"})).equals("abc"));
    test("toList", "4 elements", toString(Lab.toList(new String[]{"abcd"})).equals("abcd"));
    test("toList", "5 elements", toString(Lab.toList(new String[]{"abcde"})).equals("abcde"));
