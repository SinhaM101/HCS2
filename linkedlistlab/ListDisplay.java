...
public class ListDisplay implements ActionListener
{
  ...
  public static String[] IMAGE_NAMES = {"mouse", "chicken", "pig", "sheep", "duck", "horse", "cow"};
  ...
  public ListDisplay()
  {
    ...
    button = new JButton("Lab.hasDuplicate(" + VAR_NAME + ")");
    button.setActionCommand("hasDuplicate");
    button.addActionListener(this);
    frame.getContentPane().add(button);
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
      first = new ListNode<String>(chooseAnimal(false), null);
      update();
    }
    ...
    else if (command.equals("hasDuplicate"))
    {
      boolean result = Lab.hasDuplicate(first);
      update();
      JOptionPane.showMessageDialog(topButton, "" + result);
    }
