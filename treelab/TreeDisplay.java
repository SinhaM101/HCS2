...
public class TreeDisplay<E> extends JComponent
{
  ...
  public void showTree(TreeNode<E> root)
  {
    this.root = copy(root);
  ...
  public static <E> TreeNode<E> copy(TreeNode<E> t)
  {
    if (t == null)
      return null;
    else
    {
      TreeNode<E> copy = new TreeNode<E>(t.getValue());
      copy.setLeft(copy(t.getLeft()));
      copy.setRight(copy(t.getRight()));
      return copy;
    }
  }
